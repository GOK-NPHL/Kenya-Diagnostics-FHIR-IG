...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest">
      <sch:assert test="count(f:extension[@url = 'http://fhir.nphl.go.ke/StructureDefinition/rejection-reasons-for-labOrder']) &lt;= 1">extension with URL = 'http://fhir.nphl.go.ke/StructureDefinition/rejection-reasons-for-labOrder': maximum cardinality of 'extension' is 1</sch:assert>
